...
const GenericComponent = ({
  ...
  return (
    <div
      className={`border ${error ? "border-[#B15FE8]" : "border-stone-700"} bg-stone-900/45 rounded-lg p-6 min-h-[100px] ${className}`}
    >
      <div className="flex justify-between items-center mb-6">
        {showActions && (
          <div className="text-stone-500 cursor-pointer hover:text-white">
            •••
          </div>
        )}
      ...
      {error ? (
        ...
        >
          <div className="text-stone-300 text-lg leading-relaxed">
            <p className="mb-4">{t("error_loading_content")}</p>
            <p className="italic">
